/*
===============================================================================
Creating Stored Procedure for loading Bronze layer (Source -> Bronze)
===============================================================================
Script Purpose :
	This stored procedure named 'bronze.load_bronze' loads data from external 
	CSV files into 'bronze' schema.
	-- First it truncates the bronze tables before loading data
	-- Second it uses the 'BULK INSERT' command to load data from csv files
	to 'bronze' schema
...
USAGE : To use this stored procedure -
		Run SQL Query : 'EXEC bronze.load_bronze' ; 
===============================================================================
*/
